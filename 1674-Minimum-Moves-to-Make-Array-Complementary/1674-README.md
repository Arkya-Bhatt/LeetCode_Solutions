...
Return _the **minimum** number of moves required to make_ `nums` _**complementary**_.
...
**Output:** 1 \
**Explanation:** In 1 move, you can change nums to [1,<u>2</u>,<u>2</u>,3] (underlined elements are changed). \
nums[0] + nums[3] = 1 + 3 = 4. \
nums[1] + nums[2] = 2 + 2 = 4. \
nums[2] + nums[1] = 2 + 2 = 4. \
nums[3] + nums[0] = 3 + 1 = 4. \
